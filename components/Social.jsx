...
const Social = () => {
  return (
    <div className="flex items-center justify-center mt-4 p-4">
      <a href="https://www.facebook.com/helmar.baechle" className="ml-4" aria-label="Facebook" rel="noopener">
        <svg className="h-6 w-6 hover:text-hot-pink" xmlns="http://www.w3.org/2000/svg" version="1.1"
          xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16" width="16"
          height="16">
          <g transform="matrix(0.6666666666666666,0,0,0.6666666666666666,0,0)">
            <path
              ...
              stroke="none" fill="currentColor" strokeWidth="0" strokeLinecap="round" strokeLinejoin="round"></path>
          </g>
        </svg>
      </a>


      <a href="https://www.youtube.com/@alwayssomewhere716" className="ml-4" aria-label="YouTube"
      ...
      <a href="https://github.com/helmar81" className="ml-4" aria-label="Github" target="_blank">
        <svg className="h-6 w-6 hover:text-hot-pink" xmlns="http://www.w3.org/2000/svg" version="1.1"
          xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16" width="16"
          height="16">
          <g transform="matrix(0.6666666666666666,0,0,0.6666666666666666,0,0)">
      ...
      <a href="mailto:uspekhiwebdesign@gmail.com" className="ml-4" aria-label="Email" rel="noopener">
        <svg className="h-6 w-6 hover:text-hot-pink" xmlns="http://www.w3.org/2000/svg" version="1.1"
          xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16" width="16"
          height="16">
          <g transform="matrix(0.6666666666666666,0,0,0.6666666666666666,0,0)">
            <path
              ...
              stroke="currentColor" fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
            <path d="M 15.687,9.975L19.5,13.5 " stroke="currentColor" fill="none" strokeWidth="1.5"
              strokeLinecap="round" strokeLinejoin="round"></path>
            <path d="M 8.313,9.975L4.5,13.5 " stroke="currentColor" fill="none" strokeWidth="1.5" strokeLinecap="round"
              strokeLinejoin="round"></path>
            <path d="M 22.88,5.014l-9.513,6.56 c-0.823,0.568-1.911,0.568-2.734,0L1.12,5.014" stroke="currentColor"
              fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
          </g>
        </svg>
      </a>

      {/* Iconify icon - might require additional setup in Next.js */}
